...
def preprocess(df: pd.DataFrame, input_dir: str) -> None:
    ...
    x_trai.to_csv(os.path.join(input_dir, "x_trai.csv"))
    x_vali.to_csv(os.path.join(input_dir, "x_vali.csv"))
    x_test.to_csv(os.path.join(input_dir, "x_test.csv"))
    y_trai.to_csv(os.path.join(input_dir, "y_trai.csv"), header=True)
    y_vali.to_csv(os.path.join(input_dir, "y_vali.csv"), header=True)
    y_test.to_csv(os.path.join(input_dir, "y_test.csv"), header=True)
